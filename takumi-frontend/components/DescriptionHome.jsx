            ...
            <div className="relative z-10 w-full min-h-full flex items-center justify-center lg:justify-start flex-row-reverse ">
                <div className="max-w-full px-6 lg:px-20 xl:px-40 py-20">
                    <div className=" flex flex-row-reverse">
                        <h2 className="text-4xl lg:text-5xl font-bold text-darkbrown mb-6 writing-mode-vertical-rl ml-2 lg:ml-8">
                            匠の職人
                        </h2>
                        {/* Diamond and Line */}
                        ...
                        <div className="text-base lg:text-xl text-darkbrown mb-8 writing-mode-vertical-rl flex flex-col gap-4 lg:gap-12 xl:gap-20">
                            <p>ここは背景を職人が</p>
                            <p>有田焼を製作している風景の動画</p>
                            <p>その上に簡単な紹介文を置く</p>
                            <p>ホバーすると紹介文章が消える</p>
